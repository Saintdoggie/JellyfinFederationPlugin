...
- [x] `LocalMediaMountService` owns its rclone process, starts without a shell, verifies an instance-specific marker and restores the mount after restart. Driver/rclone installation remains manual. Owner UI shows current mount status and setup guidance.
